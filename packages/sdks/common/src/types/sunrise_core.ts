export type SunriseCore = {
  ...
  instructions: [
    {
      name: "registerState";
      docs: ["Initializes a [State], setting its initial parameters."];
      accounts: [
        {
          name: "payer";
          isMut: true;
    ...
    {
      name: "updateState";
      docs: ["Updates a [State] without modifying its [BeamDetails] list."];
      accounts: [
        {
          name: "state";
          isMut: true;
    ...
    },
    {
      ...
      docs: ["Exports the gsol mint authority to a new account."];
      accounts: [
        {
          name: "updateAuthority";
          isMut: false;
  ...
  accounts: [
    {
      name: "state";
      docs: ["The state for the Sunrise beam controller program."];
      type: {
        kind: "struct";
        fields: [
          {
            name: "updateAuthority";
            docs: ["Update authority for this state."];
            type: "publicKey";
          },
          {
            name: "gsolMint";
            docs: ["The Sunrise gSol mint."];
            type: "publicKey";
          },
          {
            name: "preSupply";
          ...
          },
          {
            ...
            docs: ["Bump of the gSol mint authority PDA."];
            type: "u8";
          },
          {
            name: "yieldAccount";
            docs: ["The Sunrise yield account."];
            type: "publicKey";
          },
          {
            name: "allocations";
            docs: ["Holds [BeamDetails] for all supported beams."];
            type: {
              vec: {
                defined: "BeamDetails";
              };
  ...
  types: [
    {
      name: "BeamDetails";
      docs: ["Holds information about a registed beam."];
      type: {
        kind: "struct";
        fields: [
          {
            name: "key";
            docs: ["Expected signer for mint and burn requests."];
            type: "publicKey";
          },
          {
            name: "allocation";
            docs: ["This beam's allocation expressed as a percentage."];
            type: "u8";
          },
          {
          ...
          {
            name: "drainingMode";
            docs: ["A beam in drain accepts withdrawals but not deposits."];
            type: "bool";
          },
        ];
      };
    },
    {
      ...
      docs: ["Arguments for registering a new [State]."];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    },
    {
      ...
      docs: ["Arguments for updating [State] parameters."];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    },
    {
      ...
      docs: ["Arguments for updating a beam's allocation."];
      type: {
        kind: "struct";
        fields: [
          {
